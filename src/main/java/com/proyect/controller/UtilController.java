...
public class UtilController {
	...
	public String index(Model model) {
		...
		List<Producto> productoLists = productoService.listarRegistrosActivoTrue();
	...
	/*@GetMapping("/listarProductoActivoTrue")
	@ResponseBody
	public Page<DTOProductoList> listarProducto(Pageable page) {
		return productoService.listarRegistrosActivoTrue(page);
	}*/
